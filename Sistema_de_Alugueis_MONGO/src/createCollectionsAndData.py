...
LIST_OF_COLLECTIONS = ["montadoras", "clientes", "veiculos", "alugueis", "itens_aluguel"]
...
def extract_and_insert():
    ...
    for collection in LIST_OF_COLLECTIONS:
        ...
        if collection == "alugueis":
            df["data_aluguel_inicial"] = df["data_aluguel_inicial"].dt.strftime("%m-%d-%Y")
            df["data_aluguel_final"] = df["data_aluguel_final"].dt.strftime("%m-%d-%Y")
